...
- Office Preview Word/Excel/PowerPoint, corrected Edge, and New Outlook launch/find/place passed on one local Login Enterprise 6.8.6 machine. Classic Outlook and New Outlook interaction automation remain runtime-pending; representative KW workloads remain static/build validated only.
