...
`netstandard2.0` was chosen as a conservative single-assembly portability target that can be consumed by mature .NET Framework-era hosts as well as modern .NET without requiring a Login Enterprise reference. Login Enterprise 6.8.6 Script Editor/Standalone Engine loaded and invoked the assembly successfully on August 18, 2026. That single environment does not establish broader release, platform, or VDI compatibility.
