...
public class M365Excel524 : ScriptBase
{
    ...
    Type _multiMonitorPlacerType;
    string _multiMonitorStatePath;
    int _previewMonitorIndex = -1;
    ...
    private void Execute()
    {
        ...
        PlaceOnMonitor(_activeDocument, "Microsoft Excel", _previewMonitorIndex);
    ...
    IWindow OpenLoginVsiDoc()
    {
        ...
        _previewMonitorIndex = PlaceNext(_activeDocument, "Microsoft Excel");
    ...
    void InitializeMultiMonitorPreview()
    {
    ...
    int PlaceNext(IWindow window, string applicationName)
    {
    ...
    void PlaceOnMonitor(IWindow window, string applicationName, int targetMonitorIndex)
    {
    ...
    object InvokePlacement(string methodName, object[] arguments)
    {
    ...
    static object GetPlacementProperty(object result, string name)
    {
